...
const generateAlertsForUnit = (u: VRU): Alert[] => {
    ...
    // Airport 3: Oil Pump Overload (Starting Feb 27)
    if (u.id === 'VRU-A03') {
        alerts.push({
            id: 'ALT-A03-OILPUMP-OVERLOAD',
            severity: 'Critical',
            message: 'Oil Pump Overload',
            timestamp: '2026-02-27T10:00:00.000Z', // Feb 27th
            acknowledged: false,
            machineId: u.id,
            machineName: u.name
        });
...
export const generateGecoFleet = (): VRU[] => {
    return [
        ...
        },
        {
            ...
            healthScore: 97,
            alerts: [],
            stationDetails: { pumps: 8, tanks91: 2, tanks95: 2, trucksPerDay: 3, dailySalesLiters: 34000 }
        },
        {
            id: 'GECO-ARIRANG',
            name: 'ARIRANG',
            ...
            healthScore: 98,
            alerts: [],
            stationDetails: { pumps: 10, tanks91: 2, tanks95: 2, trucksPerDay: 4, dailySalesLiters: 36000 }
        },
        {
            id: 'GECO-SOIL-CLOVER',
            name: 'S-OIL-CLOVER',
            ...
            healthScore: 96,
            alerts: [],
            stationDetails: { pumps: 6, tanks91: 1, tanks95: 1, trucksPerDay: 2, dailySalesLiters: 28000 }
        },
        {
            id: 'GECO-IRONMAN',
            name: 'IRONMAN',
            ...
            healthScore: 97,
            alerts: [],
            stationDetails: { pumps: 8, tanks91: 2, tanks95: 2, trucksPerDay: 3, dailySalesLiters: 33000 }
        },
        {
            id: 'GECO-OMAN-01',
        ...
        },
        {
            ...
            healthScore: 96,
            alerts: [],
            stationDetails: { pumps: 6, tanks91: 1, tanks95: 1, trucksPerDay: 2, dailySalesLiters: 27000 }
        },
        {
            id: 'GECO-MYONG-POOM',
            name: 'MYONG-POOM',
            ...
            healthScore: 97,
            alerts: [],
            stationDetails: { pumps: 8, tanks91: 2, tanks95: 2, trucksPerDay: 3, dailySalesLiters: 30000 }
        },
        {
            id: 'GECO-NEW-TOWN',
            name: 'NEW-TOWN',
        ...
        },
        {
            ...
            healthScore: 97,
            alerts: [],
            stationDetails: { pumps: 8, tanks91: 2, tanks95: 2, trucksPerDay: 3, dailySalesLiters: 31000 }
        },
        {
            id: 'GECO-BETMAN-02',
            name: 'BETMAN-02',
            ...
            healthScore: 97,
            alerts: [],
            stationDetails: { pumps: 8, tanks91: 2, tanks95: 2, trucksPerDay: 3, dailySalesLiters: 31500 }
        }
    ];
};
